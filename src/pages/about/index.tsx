    ...
    <section className="container mx-auto px-4 py-12">
      ...
      >
        ...
        <p className="mx-auto max-w-2xl text-xl text-gray-600">
          ...
          We&apos;re dedicated to enhancing your movie-watching experience with
          the latest information, reviews, and a vast collection of films.
        </p>
      </motion.section>
      ...
      >
        ...
        <p className="mx-auto max-w-3xl text-lg text-gray-600">
          ...
          experience not just enjoyable, but extraordinary. Whether you&apos;re
          a seasoned cinephile or just looking for a great flick to unwind,
          we&apos;re here to guide you through the wonderful world of cinema.
        </p>
      </motion.section>
    </section>
  );
